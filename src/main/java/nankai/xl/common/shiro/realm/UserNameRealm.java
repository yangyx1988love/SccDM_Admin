package nankai.xl.common.shiro.realm;
...
public class UserNameRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        Set<String> roles = adminuserService.selectRoleNameByUserName(username);
        Set<String> perms = adminuserService.selectPermsByUsername(username);
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        Adminuser user = adminuserService.selectOneByUserName(username);
        if (user == null) {
