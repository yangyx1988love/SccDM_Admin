...
public class FileUtil {
	 ...
	 */
	public static List<String> getAllFileNameByType(String path,String type) throws IOException {
					...
					if(fileName!=null){
						...
						if(suffix.equals(type)){
							if ((dot >-1) && (dot < (fileName.length()))) {
								fileNames.add(fileName.substring(0, dot));
							}
						}
					}
				} 
	...
	public static List<String> readFiles2List(String filepath,String chartcode) throws Exception {

			//String fileEncode=EncodingDetect.getJavaEncode(filePath);
			FileInputStream fis = new FileInputStream(filepath);   
			InputStreamReader isr = new InputStreamReader(fis, chartcode);   
    ...
    public static String getChartCode(String fileName) throws Exception {
